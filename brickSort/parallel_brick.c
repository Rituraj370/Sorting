...
// A function to sort the algorithm using parallel Odd Even sort
...
int main()
{
    ...
    parallelOddEvenSort(B, arr_size);
    end1 = omp_get_wtime();

    printf("\nSorted array is :\n");
	printArray(arr, arr_size);
    printf("\nExecution time in serial Brick sort is : %f seconds\n\n", end-start);
    printf("\nExecution time in parallel Brick sort is : %f seconds\n\n", end1-start1);
